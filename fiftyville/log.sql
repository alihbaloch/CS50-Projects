...
WHERE bakery_security_logs.hour = 10 AND bakery_secuirty_log.minute = 1   AND atm_transactions.day = 28 AND atm_transactions.month = 7 AND atm_transactions.atm_location = 'Leggett Street';